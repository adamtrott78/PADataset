...
%   WIFI/pilot_out_v01/evidence_pack_ota_quick/ota_quick_summary.mat
    ...
    data_ota = P.data_wifi_spliced_v05;
    assert(isfolder(data_ota), "Missing data_ota: %s", data_ota);

    out_root = P.results_wifi_ota_eval_quick;
    out_png  = P.results_wifi_ota_eval_quick_png;
    ...
    cfg = pa_load_cfg(fullfile(P.config,"starter_ota12.json"));
