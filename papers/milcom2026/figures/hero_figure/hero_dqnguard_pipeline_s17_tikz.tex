...
\node[block, fill=modelfill, minimum width=11.8mm, minimum height=9.0mm] (cnn) at (67.2,27.4)
{\textbf{\scriptsize PA CNN}\\[-0.8pt] {\tiny encoder + head}};

% Metrics, ordered for clean routing
\node[metric, minimum width=14.8mm, minimum height=7.8mm] (yhat) at (84.0,39.0)
{\textbf{\scriptsize PA pred.}\\[-1pt] {\scriptsize \(\hat{y}\)}};

\node[metric, minimum width=14.8mm, minimum height=7.8mm] (zlog) at (84.0,29.6)
{\textbf{\scriptsize logits}\\[-1pt] {\scriptsize \(z\)}};

\node[metric, minimum width=14.8mm, minimum height=7.8mm] (psoft) at (84.0,20.2)
{\textbf{\scriptsize softmax}\\[-1pt] {\scriptsize \(p\)}};

\node[metric, minimum width=14.8mm, minimum height=7.8mm] (hfeat) at (84.0,10.8)
...
{\textbf{\scriptsize Predicted-class calibration}\\[-0.6pt] {\tiny select bands for \(\hat{y}\)}};
