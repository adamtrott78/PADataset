...
\node[font=\sffamily\bfseries\small] at (11.25,47.0) {RF Signal Input};
...
% Fusion and model
\node[block, fill=fusionfill, minimum width=16.0mm, minimum height=8.4mm] (fusion) at (50.5,27.4)
{\textbf{\tiny Concat + AvgPool(8192)}};

\node[block, fill=modelfill, minimum width=10.8mm, minimum height=8.0mm] (cnn) at (70.5,27.4)
{\textbf{\scriptsize PA CNN}};

% Metrics, ordered for clean routing. Slightly smaller to create arrow space.
\node[metric, minimum width=12.8mm, minimum height=7.2mm] (yhat) at (91.0,39.0)
{\textbf{\scriptsize PA pred.}\\[-1pt] {\scriptsize \(\hat{y}\)}};

\node[metric, minimum width=12.8mm, minimum height=7.2mm] (zlog) at (91.0,29.6)
{\textbf{\scriptsize logits}\\[-1pt] {\scriptsize \(z\)}};

\node[metric, minimum width=12.8mm, minimum height=7.2mm] (psoft) at (91.0,20.2)
{\textbf{\scriptsize softmax}\\[-1pt] {\scriptsize \(p\)}};

\node[metric, minimum width=12.8mm, minimum height=7.2mm] (hfeat) at (91.0,10.8)
