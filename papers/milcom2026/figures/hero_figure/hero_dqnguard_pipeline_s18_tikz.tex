...
% ---------------------------------------------------------------------
\node[inputpanel, minimum width=23mm, minimum height=50mm, anchor=south west] (inputpanel) at (0,0) {};
\node[encoderpanel, minimum width=72.5mm, minimum height=50mm, anchor=south west] (encpanel) at (24.5,0) {};
\node[guardpanelstyle, minimum width=42mm, minimum height=50mm, anchor=south west] (guardpanel) at (98.5,0) {};
\node[outputpanelstyle, minimum width=43.5mm, minimum height=50mm, anchor=south west] (outpanel) at (142,0) {};

% Panel titles are intentionally larger than blob titles.
\node[font=\sffamily\bfseries\small] at (11.5,47.0) {RF Signal Input};
\node[font=\sffamily\bfseries\small] at (60.75,47.0) {Multi-Domain PA Encoder};
\node[font=\sffamily\bfseries\small] at (119.5,47.2) {DQNGuard};
\node[font=\sffamily\bfseries\small, align=center] at (163.75,47.0) {Evidence Outputs\\[-0.5pt] and Consumers};

% ---------------------------------------------------------------------
% RF input
% ---------------------------------------------------------------------
\node[block, minimum width=16.8mm, minimum height=7.0mm] (rf) at (11.5,25.0)
...
% Fusion and model
\node[block, fill=fusionfill, minimum width=16.0mm, minimum height=9.4mm] (fusion) at (52.0,27.4)
{\textbf{\tiny Concat + AvgPool}\\[-0.8pt] {\scriptsize \(N=8192\)}};

\node[block, fill=modelfill, minimum width=12.2mm, minimum height=9.0mm] (cnn) at (69.5,27.4)
{\textbf{\scriptsize PA CNN}\\[-0.8pt] {\scriptsize encoder + head}};

% Metrics, ordered for clean routing. Slightly smaller to create arrow space.
\node[metric, minimum width=13.6mm, minimum height=7.4mm] (yhat) at (87.8,39.0)
{\textbf{\scriptsize PA pred.}\\[-1pt] {\scriptsize \(\hat{y}\)}};

\node[metric, minimum width=13.6mm, minimum height=7.4mm] (zlog) at (87.8,29.6)
{\textbf{\scriptsize logits}\\[-1pt] {\scriptsize \(z\)}};

\node[metric, minimum width=13.6mm, minimum height=7.4mm] (psoft) at (87.8,20.2)
{\textbf{\scriptsize softmax}\\[-1pt] {\scriptsize \(p\)}};

\node[metric, minimum width=13.6mm, minimum height=7.4mm] (hfeat) at (87.8,10.8)
{\textbf{\scriptsize feature}\\[-1pt] {\scriptsize \(h\)}};

% ---------------------------------------------------------------------
% DQNGuard stages
% ---------------------------------------------------------------------
\node[stage, minimum width=38.2mm, minimum height=9.7mm] (cal) at (119.5,39.0)
{\textbf{\scriptsize Predicted-class calibration}\\[-0.4pt] {\scriptsize select bands for \(\hat{y}\)}};

\node[stage, minimum width=38.2mm, minimum height=9.7mm] (evid) at (119.5,25.0)
{\textbf{\scriptsize Guard evidence}\\[-0.4pt]
{\scriptsize \(P_1,\;P_1-P_2,\;H\)}\\[-1.0pt]
{\scriptsize \(V,\;E,\;r(x)\)}};

\node[stage, minimum width=38.2mm, minimum height=9.7mm] (thresh) at (119.5,11.0)
...
% Outputs
% ---------------------------------------------------------------------
\node[knownbox, minimum width=20.0mm, minimum height=8.8mm] (known) at (153.3,37.5)
{\textbf{\scriptsize Known PA evidence}\\[-0.6pt]
{\tiny Scan / Burst /}\\[-0.8pt]
{\tiny Sustain / Hop / Replay}};

\node[unknownbox, minimum width=20.4mm, minimum height=8.8mm] (unknown) at (153.3,16.0)
{\textbf{\scriptsize Unknown pool}\\[-0.6pt]
{\tiny candidate novel}\\[-0.8pt]
{\tiny signal behavior}};

\node[attackbox, minimum width=17.6mm, minimum height=7.4mm] (attack) at (176.2,38.2)
{\textbf{\scriptsize ATT\&CK/EW}\\[-0.7pt]\textbf{\scriptsize hypotheses}};

\node[llmbox, minimum width=17.6mm, minimum height=7.4mm] (llm) at (176.2,25.0)
{\textbf{\scriptsize LLM}\\[-0.7pt]\textbf{\scriptsize label-making}};

\node[qrcwosbox, minimum width=17.6mm, minimum height=7.4mm] (qrcwos) at (176.2,11.8)
