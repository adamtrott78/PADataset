#!/usr/bin/env python3
"""
Generate Hero Figure Candidate S12.

S12 is a typography harmonization pass over S11:
  - formal panel names;
  - cleaner font stack;
  - shorter labels;
...
def header() -> str:
    return (
        ...
        '  .subtitle { font-size: 16.5px; font-weight: 500; fill: #475467; }\n'
        '  .label { font-size: 20px; font-weight: 700; fill: #18212b; }\n'
        '  .detail { font-size: 18px; font-weight: 650; fill: #18212b; }\n'
        '  .small { font-size: 15.8px; font-weight: 500; fill: #3f4a56; }\n'
        '  .tiny { font-size: 14.8px; font-weight: 500; fill: #3f4a56; }\n'
        ...
        '  .mathtiny { font-family: "Liberation Serif", "Times New Roman", Times, serif; font-size: 17.5px; font-style: italic; font-weight: 700; fill: #18212b; }\n'
        '</style>\n'
    )
...
def main() -> None:
    ...
    parser.add_argument("--name", default="hero_dqnguard_pipeline_s12_horizontal")
