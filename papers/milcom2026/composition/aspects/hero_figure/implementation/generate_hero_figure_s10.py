#!/usr/bin/env python3
"""
Generate Hero Figure Candidate S10.

S10 is a typography harmonization pass over S9:
  - formal panel names;
  - cleaner font stack;
  - shorter labels;
...
def main() -> None:
    ...
    parser.add_argument("--name", default="hero_dqnguard_pipeline_s10_horizontal")
