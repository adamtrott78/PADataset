#!/usr/bin/env python3
"""
Generate Hero Figure Candidate S11.

S11 is a final metric-size and title-style harmonization pass over S10:
  - formal panel names;
  - cleaner font stack;
  - shorter labels;
...
def header() -> str:
    return (
        ...
        '  .detail { font-size: 18px; font-weight: 500; fill: #2f3742; }\n'
        '  .small { font-size: 16px; fill: #384252; }\n'
        '  .tiny { font-size: 15px; fill: #384252; }\n'
...
def build_svg() -> str:
    ...
    for (name, var), y in zip(metrics, metric_ys):
        ...
        s.append(
            ...
            f'font-size: 24px; font-style: italic; fill: #18212b;">{esc(var)}</text>\n'
        )
...
def main() -> None:
    ...
    parser.add_argument("--name", default="hero_dqnguard_pipeline_s11_horizontal")
